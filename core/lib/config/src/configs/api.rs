...
mod tests {
    ...
    fn expected_config() -> ApiConfig {
        ApiConfig {
            ...
            admin: AdminApi {
                port: 9078,
                url: "http://127.0.0.1:9078".into(),
                secret_auth: "sample".into(),
            },
            rest: RestApi {
                port: 3999,
                url: "http://127.0.0.1:3999".into(),
            },
            json_rpc: JsonRpc {
                http_port: 4028,
                http_url: "http://127.0.0.1:4028".into(),
                ws_port: 4029,
                ws_url: "ws://127.0.0.1:4029".into(),
            },
            private: PrivateApi {
                port: 9088,
                url: "http://127.0.0.1:9088".into(),
            },
            prover: ProverApi {
                port: 9086,
                url: "http://127.0.0.1:9086".into(),
                secret_auth: "sample".into(),
            },
